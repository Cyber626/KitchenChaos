...
public class GameManager : MonoBehaviour
{
    ...
    public event EventHandler OnStateChanged, OnGamePaused, OnGameUnpaused;
    ...
    private float gamePlayingtTimer = 0;
    private float gamePlayingtTimerMax = 200;
    ...
    public float GetPlayingTimerNormalized() { return 1 - (gamePlayingtTimer / gamePlayingtTimerMax); }
